# Online.NET Core FullStack Backend + FrontEnd Uygulama Geliştirme Kursu – Sık Sorulan Sorular
...
+ __Online.NET Core FullStack Backend-FrontEnd Uygulama Gelistirme Kursu__ çok kolay değil. Eğitimde şüphesiz zorlandığınız yerler olacak. Bu sizin moralinizi bozmamalı, motivasyonunuzu düşürmemeli. Eğer yeterli zaman ayırıp, çaba gösterirseniz zaman içinde her şey yerine oturacak. Biraz sabırlı olmalısınız.
...
Bu kursa katılabilmeniz için daha önce C# ile Nesne Yönelimli Programlama konusunda çalışma yapmış olmanız ya da C ve Sistem Programcıları Derneği’nin açmış olduğu C# ile Nesne Yönelimli Programlama kursuna katılmış olmanız gerekmektedir.
